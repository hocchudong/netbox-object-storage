...
from ..models import Cluster, Bucket, Pool
...
class BucketSerializer(NetBoxModelSerializer):
    ...
    class Meta:
        model = Bucket
        fields = fields = (
            'id', 'url', 'display', 'name', 'capacity', 'credential', 'url', 
            'access','assigned_object_type', 'assigned_object_id', 'assigned_object', 
...
class NestedClusterSerializer(WritableNestedSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name='plugins-api:netbox_object_storage-api:cluster-detail'
    )
